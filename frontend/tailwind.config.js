...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      /* Ребрендинг «Мягкий SaaS» (Вариант A): дружелюбные скругления вместо
         строгих 2–4px. Одна правка задаёт форму всей системы (rounded-* по
         всему приложению подхватывают новые значения). */
      borderRadius: {
        none: '0',
        sm: '6px',
        DEFAULT: '8px',
