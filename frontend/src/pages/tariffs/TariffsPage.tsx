      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-surface-100 dark:bg-surface-700/60 text-sm"
          />
        </div>
    ...
    >
      <FormField label="Название" required error={errors.name?.message as string}>
        <input
          ...
          className="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-surface-100 dark:bg-surface-700/60"
        />
      </FormField>
      ...
      <div className="grid grid-cols-2 gap-3">
        {canSeeFinance ? (
          <FormField label="Цена / мес (сомони)" required>
            <input type="number" step="0.01" {...register('monthlyPrice')} className="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-surface-100 dark:bg-surface-700/60" />
          </FormField>
        ) : (
        ...
        <FormField label="Длительность (дней)">
          <input type="number" {...register('durationDays')} className="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-surface-100 dark:bg-surface-700/60" />
        </FormField>
      </div>
      ...
      >
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <FormField label="Stories"><input type="number" {...register('storiesPerMonth')} className="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-surface-100 dark:bg-surface-700/60" /></FormField>
          <FormField label="Reels"><input type="number" {...register('reelsPerMonth')} className="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-surface-100 dark:bg-surface-700/60" /></FormField>
          <FormField label="Posts"><input type="number" {...register('postsPerMonth')} className="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-surface-100 dark:bg-surface-700/60" /></FormField>
          <FormField label="Дизайны"><input type="number" {...register('designsPerMonth')} className="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-surface-100 dark:bg-surface-700/60" /></FormField>
        </div>
      </CollapsibleField>
      ...
      >
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          <FormField label="Съёмок / мес"><input type="number" {...register('shootingDaysPerMonth')} className="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-surface-100 dark:bg-surface-700/60" /></FormField>
          <FormField label="Отчётов / мес"><input type="number" {...register('reportsPerMonth')} className="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-surface-100 dark:bg-surface-700/60" /></FormField>
          <FormField label="Лимит правок"><input type="number" {...register('revisionLimit')} className="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-surface-100 dark:bg-surface-700/60" /></FormField>
        </div>
      </CollapsibleField>
