...
describe('TransactionDetailsPanel', () => {
  it('shows who received an advance and its payroll period', () => {
    render(<div className="fin-root"><TransactionDetailsPanel
      id="transaction-details-test"
      transaction={{
  ...
  it('moves from read view to editing when requested', async () => {
    ...
    render(<div className="fin-root"><TransactionDetailsPanel id="transaction-details-test" transaction={tx} onClose={() => {}} onEdit={onEdit} /></div>);
