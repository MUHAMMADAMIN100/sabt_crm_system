...
const secLabel = 'text-[11px] font-bold uppercase tracking-wider text-gray-400 mb-2.5'

// Модалка создания SMM-проекта (упрощённый шаблон: цикл/норма/сторис + клиент). Не общая dev-форма.
    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center p-4 py-8 bg-black/50 overflow-auto"
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-2xl">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-gray-800">
          <h2 className="text-lg font-bold">Новый SMM-проект</h2>
        ...
        <div className="p-5 space-y-5">
          ...
          <div>
            <p className={secLabel}>Цикл и норма</p>
          ...
          <div>
            <p className={secLabel}>О клиенте</p>
            ...
            <label className="block mt-3"><span className="text-xs text-gray-500">Предпочтения</span><textarea value={preferences} onChange={e => setPreferences(e.target.value)} rows={3} placeholder="Тон, что любят/не любят, правила согласования…" className={inp + ' mt-1 resize-y leading-relaxed'} /></label>
          </div>
        </div>
