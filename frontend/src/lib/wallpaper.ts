...
/** Обои доступны любому сотруднику: настройка персональная, ручки на бэке
 *  работают только со «своим» пользователем. Проверка оставлена функцией —
 *  вызовов много, и она же отсекает неавторизованного. */
